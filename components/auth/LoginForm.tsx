    ...
    <div className="flex min-h-screen w-full bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      <div className="flex w-full items-center justify-center px-4 py-1 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          {/* Header */}
          <div className="mb-4">
            <h1 className="text-3xl font-bold tracking-tight text-pw-black">Willkommen zurück</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              <div className="mb-2 flex items-center justify-between">
                <label htmlFor="password" className="block text-sm font-medium text-pw-black">
                  Passwort
                </label>
                <Link
                  href="/auth/reset-password"
                  className="hover:text-pw-black/70 text-sm font-medium text-pw-black underline transition-colors"
                >
                  Passwort vergessen?
                </Link>
              </div>
