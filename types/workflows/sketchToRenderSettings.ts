/**
 * Sketch-to-Render Settings Type Definitions
 *
...
/**
 * Main sketch-to-render settings interface
 * All fields are optional and nullable for flexible configuration
 */
export interface SketchToRenderSettingsType {
...
/**
 * Default sketch-to-render settings with all fields set to null
 * Use as starting point for new render configurations
 */
export const DEFAULT_SKETCH_TO_RENDER_SETTINGS: SketchToRenderSettingsType = {
  spaceType: null,
  aspectRatio: null,
  designStyle: null,
  renderStyle: null,
 ...
 */
export const SKETCH_TO_RENDER_SETTINGS_LABELS: Record<string, Record<string, string>> = {
  spaceType: {
    interior: "Interior",
    exterior: "Exterior",
  },
 ...
 */
export const PRESET_CONFIGURATIONS: Record<string, SketchToRenderSettingsType> = {
  architektur: {
    spaceType: null,
    aspectRatio: "16:9",
...
export const isValidSpaceType = (
  value: unknown
): value is NonNullable<SketchToRenderSettingsType["spaceType"]> => {
  return SPACE_TYPE_OPTIONS.includes(value as any);
};

export const isValidDesignStyle = (
  value: unknown
): value is NonNullable<SketchToRenderSettingsType["designStyle"]> => {
  return DESIGN_STYLE_OPTIONS.includes(value as any);
};

export const isValidRenderStyle = (
  value: unknown
): value is NonNullable<SketchToRenderSettingsType["renderStyle"]> => {
